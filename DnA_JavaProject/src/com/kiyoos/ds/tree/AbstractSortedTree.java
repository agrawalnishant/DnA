...
public abstract class AbstractSortedTree {
	...
	public void insert(Node input) {
		...
		if (getRoot() == null) {
			...
			// change depth only if this is new child and current parent is at atleast at level == existing depth.
	...
	public void traverse(SortedTree.Traversal mode) {
